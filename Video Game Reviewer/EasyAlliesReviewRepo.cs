...
namespace Video_Game_Reviewer
{
    public class EasyAlliesReviewsRepo
    {
        public static Dictionary<string, Reviews> EasyAllies()
        {
            ...
            Reviews DevilMayCry5 = new("Ben Moore", "Devil May Cry 5", "Devil May Cry 5 has some of the best combat yet seen in an action game.", "Xbox One ", 9);
            ...
            Reviews StateOfDecay2 = new("Ben Moore", "State Of Decay 2", "State of Decay 2 is a game full of promise blanketed by bugs and an undercooked structure.", "PC and Xbox One", 6.0);
            ...
            Reviews AssassinsCreedOrigins = new("Michael Huber", "Assassin's Creed Origins", "Assassins Creed refines a decade old formula and tells an engaging story in a unique setting.", "Xbox One ", 7);
