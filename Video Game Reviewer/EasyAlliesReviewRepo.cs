...
namespace Video_Game_Reviewer
{
    public class EasyAlliesReviewsRepo
    {
        public static Dictionary<string, Reviews> EasyAllies()
        {
            ...
            Reviews Outiders = new("Michael Huber", "Outriders", "A rocky launch and outdated presentation weigh down a rewarding co-op shooter.\r\n", "Playstation 5", 7);
            ...
            Reviews GhostOfTsushima = new("Bradley Ellis", "Ghost Of Tsushima", "", "Playstation4 Pro", 8.5);
            Reviews TheLastOfUsPart2 = new("Michael Huber", "The Last Of Us Part 2", "Masterpiece", "Playstation 4 Pro", 9.5);
            ...
            Reviews DevilMayCry5 = new("Ben Moore", "Devil May Cry 5", "", "Xbox One X", 9);
            ...
            Reviews MetroExodus = new("Ben Moore", "Metro Exodus", "Despite a few technical problems, Metro Exodus creates a vast and intensely compelling world.\r\n", "PC", 8.5);
            ...
            Reviews PokemonLetsGoPikachu = new("Michael Damiani", "Pokemon Let's Go Pikachu", "Pokémon: Let’s Go, Pikachu! does introduce several new features and is a good entry point for newcomers to the series, but it ultimately leaves veterans yearning for more.\r\n", "Nintendo Switch", 7.5);
            ...
            Reviews Hitman2 = new("Michael Huber", "Hitman 2", "", "Playstation 4 Pro", 8.0);
            ...
            Reviews Cuphead = new("Brad Ellis", "Cuphead", "Cuphead's stand out visuals and fantastic encounters provide a thrilling challenge.\r\n", "Xbox One",9);
            Reviews MarioRabbidsKingdomBattle = new("Michael Damiani", "Mario + Rabbids Kingdom Battle", "", "Nintendo Switch", 9);
            ...
            Reviews MassEffectAndromeda = new("Daniel Bloodworth", "Mass Effect Andromeda", "Despite making some clear strides forward, the next chapter of Mass Effect gets off to a troubled start.\r\n", "Playstation 4", 6);
